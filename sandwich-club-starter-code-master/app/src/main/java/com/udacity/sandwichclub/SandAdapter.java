...
public class SandAdapter extends RecyclerView.Adapter<SandAdapter.ViewHolder> {

    private final List<Sandwich> SandwichList2;


    public SandAdapter(List<Sandwich> sandwichList2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_sand, viewGroup, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder( View itemView) {
            super(itemView);
            sandwichName = itemView.findViewById(R.id.sand_tv);
